...
class Public_Display {
    ...
    public function __construct() {
        ...
        add_action( 'woocommerce_account_my-collections_endpoint', array( $this, 'my_collections_content' ) );
        add_action( 'woocommerce_account_my-photos_endpoint', array( $this, 'my_photos_content' ) ); // Νέο End Point
    }
    ...
    public function add_endpoints_to_account_menu( $items ) {
        $items['my-collections'] = 'My Collections'; // Διατηρείται
        $items['my-photos'] = 'My Photos'; // Νέο End Point
        return $items;
    }
